    ...
    for sip in s.list_single_products()[0]:
        ...
        if not product:
            ...
            for p in products:
                ...
                print(str(Decimal(sip.product_base.get_moded_usual_price())), p["fields"]["manual_price"] == str(Decimal(sip.product_base.get_moded_usual_price())))
            print(str(Decimal(sip.product_base.get_moded_usual_price())))
            sys.exit("Error")
